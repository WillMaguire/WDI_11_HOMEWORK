...
var sortUid = _.sortBy(people, 'uid')
console.log(sortUid)
// Group the random words by the lower case version of their first letter
var sortWords = _.sortBy(words, function(name){return name.toLowerCase()})
console.log(sortWords)
// Check to see if all the words have more than 3 characters
var moreThan3 = _.every(words, function(arr){ return arr.length ==3 })
console.log(moreThan3)
// Check if some words are over twenty characters long
var moreThan20 = _.some(words, function(elem){ return elem.length > 20})
console.log(moreThan20)
// Get an array of all of the uids in people
var obtainUid = _.pluck(people, 'uid')
console.log(obtainUid)
// Find the person with the highest uid
var maxUid = _.max(people, function(arr){return arr.uid })
console.log(maxUid)
// Return an object that says how many even numbers and how many odd numbers there are in numbers
var returnObj = _.countBy(numbers, function(elem){ return elem%2 == 0? 'even':'odd';})
console.log(returnObj)
// Get three random numbers out of numbers
var sample = _.sample(numbers, 3)
console.log(sample)
