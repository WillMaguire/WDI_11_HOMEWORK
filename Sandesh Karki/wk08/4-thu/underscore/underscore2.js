...
var toLowerCase = _.map(words,function(word){
  return word.toLowerCase() })
var by = _.groupBy(toLowerCase, function(word){
  return firstL = word.substr(0,1);
 })

// Check to see if all the words have more than 3 characters
var wordMoreThan3Char = _.every(words, function(word){
...
var peopleUids = _.pluck(people, 'uid')

// Find the person with the highest uid
var peopleWithHighestUids = _.max(people, 'uid')
...
var threeRandNum = _.sample(numbers, [3]);
