...
var thisIdea = thisArray[Math.floor(Math.random()*thisArray.length)];
var thatIdea = thatArray[Math.floor(Math.random()*thatArray.length)];

console.log("Random Combinitaion of Great startup ideas are: \n" + thisIdea + " \n" + thatIdea);
